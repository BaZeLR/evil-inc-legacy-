            ...
            return (
              <li key={objId}>
                <div
                  ...
                  onMouseEnter={() => setHoveredMenuId?.(objId)}
                  onMouseLeave={() => setHoveredMenuId?.(prev => (prev === objId ? null : prev))}
                >
                  <button type="button" className={`corner-item-btn${selected ? ' selected' : ''}`} onClick={() => onInspect?.('object', objId, obj)}>
                    {objName}
                  </button>
