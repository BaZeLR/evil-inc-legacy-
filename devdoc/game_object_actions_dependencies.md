# Game Object Actions Menu Dependencies

This document describes the dependencies and data flow for all game objects' actions menus in the game (e.g., street vendor, duffel bag, com unit, wallet, vibranium ring, med pack, etc.).
...
- Example:
  ```json
  "Objects": [
    { "UniqueID": "comunit_001" },
    { "UniqueID": "streetvendor_001" },
    { "UniqueID": "medpack_001" }
  ]
  ```

## 2. Object JSON
- Each object JSON file (e.g., `public/DB/objects/equipment/com_unit.json`) must have:
  - A matching `UniqueID` (e.g., `comunit_001`)
